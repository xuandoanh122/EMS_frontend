...
export function TeacherForm({ defaultValues, onSubmit, isLoading, mode = 'create' }: TeacherFormProps) {
  const form = useForm<TeacherCreateFormValues>({
    ...
    defaultValues: {
      teacher_code: defaultValues?.teacher_code ?? '',
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Mã giáo viên <span className="text-destructive">*</span></FormLabel>
                  <FormControl>
                    <Input placeholder="VD: GV2024001" {...field} disabled={mode === 'edit'} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Nguyễn Thị C" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input type="email" placeholder="giaovien@example.com" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="VD: Tổ Toán - Lý" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="VD: Toán học, Vật lý" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
